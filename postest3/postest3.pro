...
clauses 
	harga(A,B,Biaya):-
		Biaya=A*B.
	pernikahan(21).
	alamat_gedung("lembuswana","gedung-1").
	alamat_gedung("tamanbudaya","gedung-2").
	...
	suami(joe,yosi).
	run:-
		write("--------- Selamat Datang Mempelai----------"),nl,
		write("Selamat Datang"),nl,
		readchar(_).

goal
	harga(12000000,50000000,Biaya_Pernikahan),
	pernikahan(Usia_suami),
